...
def gen_rand_orientation(fasta_file):
    ...
    final_seqs = [f'>{seq_rec.id}_RF1\n{seq_rec.seq}\n' for seq_rec in initial_seqs[:quarter_initial]]
    final_seqs += [change_reading_frame(seq_rec) for seq_rec in initial_seqs[quarter_initial:]]
